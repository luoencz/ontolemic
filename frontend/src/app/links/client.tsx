...
import { FaXTwitter, FaLinkedin, FaInstagram, FaGithub, FaEnvelope, FaCalendar, FaBook, FaMusic, FaCode } from "react-icons/fa6";
...
export default function LinksClient() {
    return (
        <div className="flex flex-col gap-4 w-2/3">
            <div id="contact" className="flex flex-col gap-2 bg-saphire-special/50 p-4 rounded-lg">
                <h3>Contact</h3>
            ...
            <div id="me" className="flex flex-col gap-2 bg-emerald-special/50 p-4 rounded-lg">
                <h3>Me</h3>
                <ul className="flex flex-col gap-4">
                    <LinkItem
            ...
            <div id="blogs" className="flex flex-col gap-2 bg-amber-special/50 p-4 rounded-lg">
                <h3>Blogs</h3>
                <ul className="flex flex-col gap-4">
                    <LinkItem
                        links={[
            ...
            <div id="websites" className="flex flex-col gap-2 bg-amber-special/50 p-4 rounded-lg">
                <h3>Websites</h3>
                <ul className="flex flex-col gap-4">
                    <LinkItem
            ...
            <div id="books" className="flex flex-col gap-2 bg-amber-special/50 p-4 rounded-lg">
                <h3>Books</h3>
                <ul className="flex flex-col gap-4">
                    <LinkItem
                        links={[
            ...
            <div id="music" className="flex flex-col gap-2 bg-amber-special/50 p-4 rounded-lg">
                <h3>Music</h3>
                <ul className="flex flex-col gap-4">
                    <LinkItem
                        links={[
            ...
            <div id="software" className="flex flex-col gap-2 bg-ruby-special/50 p-4 rounded-lg">
                <h3>Software</h3>
                <ul className="flex flex-col gap-4">
                    <LinkItem
